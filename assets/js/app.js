 ...
 */
 var SERVER_NAME = "Noctis Medium";
 var SERVER_IP = "noctismedium.jogar.io";
 ...
 (getServerStatus = async () => {
     ...
     document.addEventListener("DOMContentLoaded", async () => {
         ...
         null !== t &&
             (e && e.players
                 ? (t.innerHTML = e.players.online.toLocaleString())
                 : ((t.innerHTML = "offline"), t.classList.add("is-danger"), t.classList.add("is-white"), console.warn("If you're seeing this, your server on " + SERVER_IP + " could not be reached or it did not return valid data.")));
     }),
